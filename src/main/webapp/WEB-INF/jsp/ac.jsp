			...
			<fieldset class="border border-dark border-5 p-2 m-4 w-75">
				<div class="row">
					<div
						...
						<div class="mt-3">
							<img
								src="https://rukminim1.flixcart.com/image/416/416/kjvrdzk0/air-conditioner-new/e/x/q/ms-q12apye-split-dual-inverter-lg-original-imafefdpxqxgzakn.jpeg?q=70"
			...
			<fieldset class="border border-dark border-5 p-2 m-4 w-75">
				<div class="row">
					<div
						...
						<div class="mt-3">
							<img
								src="https://rukminim1.flixcart.com/image/416/416/knni7ww0/air-conditioner-new/m/l/v/ar18aynzbbe-split-samsung-fixed-speed-original-imag2ay7t8daqqhk.jpeg?q=70"
								style="width: 15vw; height: 15vh">
						</div>
					</div>
					<div class="col align-self-center">
